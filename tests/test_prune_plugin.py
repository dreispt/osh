...
def test_prune_runs_git_gc_on_clones(in_project, subprocess_check_call_capture):
...
def test_prune_skips_symlinked_sources(in_project, subprocess_check_call_capture):
...
def test_prune_aggressive_option(in_project, subprocess_check_call_capture):
...
def test_prune_dry_run_does_not_call(in_project, subprocess_check_call_capture):
